...
mixin _$WalletModel {
 ...
 String get walletName; int get amount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WalletModel&&(identical(other.walletName, walletName) || other.walletName == walletName)&&(identical(other.amount, amount) || other.amount == amount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,walletName,amount);

@override
String toString() {
  return 'WalletModel(walletName: $walletName, amount: $amount)';
}
...
/// Create a copy of WalletModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? walletName = null,Object? amount = null,}) {
  return _then(_self.copyWith(
walletName: null == walletName ? _self.walletName : walletName // ignore: cast_nullable_to_non_nullable
...
class _WalletModel implements WalletModel {
  const _WalletModel({required this.walletName, required this.amount});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WalletModel&&(identical(other.walletName, walletName) || other.walletName == walletName)&&(identical(other.amount, amount) || other.amount == amount));
}
...
/// Create a copy of WalletModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? walletName = null,Object? amount = null,}) {
